...
const page = () => {
  return (
    <div className="w-4/5 mx-auto my-10 p-6 bg-white shadow-lg rounded-lg flex flex-col gap-6">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">Interpretation and Definitions</h2>
      <h3 className="text-2xl font-semibold text-gray-700 mt-4">Interpretation</h3>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">Acknowledgment</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">Links to Other Websites</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">Limitation of Liability</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <p className="text-gray-700 leading-relaxed">
        ...
        these Terms), even if the Company or any supplier has been advised of the
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">Governing Law</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">Disputes Resolution</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">For European Union (EU) Users</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">United States Legal Compliance</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">Severability and Waiver</h2>
      <h3 className="text-2xl font-semibold text-gray-700 mt-4">Severability</h3>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">Translation Interpretation</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-teal-500 mt-6">Changes to These Terms and Conditions</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <ul className="list-disc ml-4 text-gray-700 space-y-3">
        ...
        <li>
          <p>By phone number: +91 8000400004</p>
        </li>
      </ul>
    </div>
  );
